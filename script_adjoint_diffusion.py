...
# Target Conditions
s_dev2_target, mu_target = 1.35, 1.
...
# inviscid: du/dt = nu d^2 u /dx^2




def operator_advection(u,x,t,dt,p=c_0):
    '''
...
def operator_advection_adjoint(lambda_,u,x,t,dt,p=c_0):
    '''
...
def operator_diffusion(u,x,t,dt,p=nu):
    '''
    this operator O is the RHS part of the advection term:
    O(u,x,t) = d^2u/dx^2
...
def operator_diffusion_adjoint(lambda_,u,x,t,dt,p=nu):
    '''
    this adjoint operator O is the RHS part of the advection term:
